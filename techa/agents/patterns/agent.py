...
from techa.agents.patterns.graph_nodes import prepare_node, synthesise_node, worker_node
from techa.agents.patterns._subagents import WORKER_NAMES


def _dispatcher(state: PatternScanState) -> list[Send]:
